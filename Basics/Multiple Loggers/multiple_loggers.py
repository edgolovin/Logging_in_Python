"""
Logger names can form a named hierarchy.
This allows you to selectively enable log messages at any point in this hierarchy.
You can create a new branch in the namespace by separating the logger instance name with periods.
